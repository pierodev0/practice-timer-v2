...
# mcp
- Use the codebase-memory-mcp tool for analyzing and understanding project code. Confidence: 0.60
- When user asks to check/review "engram" memory, only use engram tools (not filesystem exploration). Confidence: 0.65

# vue
- Use Vue.js for this project (migration from vanilla JS). Confidence: 0.50
...
# git
- Use conventional commit format in English for commit messages. Confidence: 0.65
